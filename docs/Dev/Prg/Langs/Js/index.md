...
+ The `var` keyword.
    ...
    + In the example below: when we re-declare the `fun` variable in *line 8*(`var fun = 20;`) after assigning new value to this var from the root scope another value in line 6(`fun = 10;`), the new var declaration in *line 5* will **override the reference** ^^inside of the function scope^^ and the root `var fun` is like we never touched it.
