...
+ Learn React JS - Full Course for Beginners - Tutorial 2019 (by freeCodeCamp.org)
  ...
  [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/DLX62G4lc44/mqdefault.jpg)](https://www.youtube.com/watch?v=DLX62G4lc44)

+ Full React Course 2020 - Learn Fundamentals, Hooks, Context API, React Router, Custom Hooks (by freeCodeCamp.org)

  [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/4UZrsTqkcW4/mqdefault.jpg)](https://www.youtube.com/watch?v=4UZrsTqkcW4)

+ React JS Crash Course 2021

  [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/w7ejDZ8SWv8/mqdefault.jpg)](https://www.youtube.com/watch?v=w7ejDZ8SWv8)

+ ReactJS - Путь Самурая

  [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/gb7gMluAeao/mqdefault.jpg)](https://www.youtube.com/watch?v=gb7gMluAeao&list=PLcvhF2Wqh7DNVy1OCUpG3i5lyxyBWhGZ8&index=1)

+ React JS - Путь Самурая 2.0

  [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/jSV2IPQz3ak/mqdefault.jpg)](https://www.youtube.com/watch?v=jSV2IPQz3ak&list=PLcvhF2Wqh7DM3z1XqMw0kPuxpbyMo3HvN&index=2)

+ ReactJS. Основы (Владилен Минин)

  [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/nwLMqAxNxKA/mqdefault.jpg)](https://www.youtube.com/watch?v=nwLMqAxNxKA&list=PLD-piGJ3Dtl0WEK67FD1bUGryqqaY_eU-&index=1)
...
+ [The React Handbook (by freeCodeCamp)](https://www.freecodecamp.org/news/the-react-handbook-b71c27b0a795/)

### Installation

Installation made by using **Create React App** npm package:

+ Reference: [Official Docs](https://create-react-app.dev/docs/getting-started), [Github](https://github.com/facebook/create-react-app)
...
[Official Docs](https://create-react-app.dev/docs/deployment)

### Definition

+ React is a **view** library.

  ?> A view is simply the web page we see. A page that displays the text, images of a website. If you build websites with HTML, then every page you create is the view like the homepage, about page, and the contact page. *More precisely:* a view is just another special template page that will be generated on the user request. It will display only the things that matter to the user’s request([source](https://medium.com/front-end-weekly/what-is-a-view-in-web-application-6a2836eed4eb)).
...
`render()` function: It is a built in function that connected to the ecosystem - which handles any changes in the view. This method should only contain the final result of what we want to return from the <mark>[component](###components)</mark>.
...
+ **Smart(container) Components:**
  ...
  + They can be *class-based* components and have their own state defined in their `constructor()` functions **or** *function-based* components using *hooks*.
    ...
    > 1. Initializing <mark>[local state](###state)</mark> by assigning an object to `this.state`.
    > 2. Binding [event handler](https://reactjs.org/docs/handling-events.html) methods to an instance.

  + Using <mark>[**props**](###props)</mark> parameter inside `constractor()` and `super()` functions:
...
+ `props` are simply things that come out of <mark>[state](###state)</mark>.
...
+ We can setup state using *class-based* component.
  ...
  ?> **Rule of thumb:** Any time we create our own methods on a class-based smart component, we use an arrow function. Futher reading: [Handling Events.](https://reactjs.org/docs/handling-events.html)
...
+ [Robofirends application using hooks](https://github.com/rogueco/robot-friends)

## Tips & Tricks

### A common way to work with forms in React

One state property takes care of the user input and the another state object takes care of passing it as a prop. Further reading about how forms are handled in React: [React Docs](https://reactjs.org/docs/forms.html).
...
[![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/-cZOdWjFwXw/mqdefault.jpg)](https://www.youtube.com/watch?v=-cZOdWjFwXw)

**Offline:**

[Video](React-50-job-interview-questions(Rus)_-cZOdWjFwXw.mp4 ':include :type=video width=320 height=180 controls')

```pdf
/Dev/Prg/LibsFwks/React/React-50-job-interview-questions(Rus).pdf
```
